...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement('UPDATE contract_pricings SET price_bgn = price WHERE price IS NOT NULL');

        // Step 3: Convert price from BGN to EUR
        DB::statement('UPDATE contract_pricings SET price = ROUND(price / ' . self::BGN_TO_EUR_RATE . ', 2) WHERE price IS NOT NULL');
    }
    ...
    public function down()
    {
        ...
        DB::statement('UPDATE contract_pricings SET price = price_bgn WHERE price_bgn IS NOT NULL');
