...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    /** @deprecated Use personUpdatePersonalInfo/{id} instead. TODO: Remove this route once confirmed safe in production. */
    ...
    Route::post('candidates/{id}/cleanup-documents', [CandidateController::class, 'cleanupContractDocuments']);
    ...
    Route::post('contracts/{id}/set-active', [\App\Http\Controllers\CandidateContractController::class, 'setActive']);
