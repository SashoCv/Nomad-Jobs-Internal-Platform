        ...
        <td style="padding: 30px;">
            ...
            <p style="font-size: 16px; color: #333;">
                ...
                <span style="font-weight: bold; color: #c0392b;">
                    Отказ от работодателя.
                </span>
            </p>

            <p style="font-size: 16px; color: #333;">
                Изпратен е уведомителен имейл към дирекция „Миграция“, МВР, и Агенция по заетостта, МТСП.
            </p>

            <p style="font-size: 16px; color: #333;">
                Можем да Ви предложим да го/я заменим с подходящ нов кандидат на същата работна позиция.
            </p>
