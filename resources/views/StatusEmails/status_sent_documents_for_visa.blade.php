        ...
        <td style="padding: 30px;">
            ...
            <p style="font-size: 16px; color: #333;">
                ...
                <span style="font-weight: bold; color: #27ae60;">
                    изпратени документи за виза.
                </span>
            </p>

            <p style="font-size: 16px; color: #333;">
                Подава се комплект документи за издаване на виза, включващи заявление,
                2 бр. снимки с размери 3,5 х 4,5, паспорт, разрешение, трудов договор,
                адресна регистрация в България и медицинска застраховка.
                Заплаща се такса за визата в размер на 100 евро за един кандидат.
            </p>
