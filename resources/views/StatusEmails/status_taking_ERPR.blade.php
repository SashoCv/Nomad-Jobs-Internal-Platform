...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
    <tr>
        <td style="padding: 30px;">
            ...
            <p style="font-size: 16px; color: #333;">
                След плащане на такса в дирекция „Миграция“ в размер на 110 лв. и съобразно вида поръчка за изготвяне на картата,
                <strong>{{ $data['candidateName'] }}</strong> ще получи разрешение за пребиваване на дата {{ $data['statusDate'] }}.
                В удобно за Вас време, можем да съдействаме при получаване на картата му/й.
            </p>
