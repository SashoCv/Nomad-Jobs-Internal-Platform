...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
    <tr>
        <td style="padding: 30px;">
            ...
            <p style="font-size: 16px; color: #333;">
                Той/тя е регистриран в дирекция „Миграция“, МВР, и очакваме повторно разрешение от Миграция
                за снимане за издаване на единно разрешение за пребиваване и работа на територията на Република България.
            </p>
