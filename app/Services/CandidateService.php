...
class CandidateService
{
    ...
    public function updateCandidate(Candidate $candidate, $data, bool $skipDocumentRegeneration = false): Candidate
    {
        return DB::transaction(function () use ($candidate, $data, $skipDocumentRegeneration) {
