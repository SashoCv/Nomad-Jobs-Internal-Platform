        ...
        try {
            ...
            if ($person->save()) {
                ...
                try {
                    ...
                    // Preserve contract_id from old file if exists
                    $contractIdForCv = $oldCvFile?->contract_id;
                    ...
                    // Generate new CV with preserved contract_id
                    $cvService = new CvDocxGeneratorService();
                    $cvService->generateAndSaveCv($person, $contractIdForCv);
                } catch (\Exception $e) {
